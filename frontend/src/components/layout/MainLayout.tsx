      ...
      <div className="p-6 space-y-4 relative z-10">
        {currentUser.role === 'WORKER' && (
          <div className="bg-amber-50 border border-amber-200 p-4 rounded-xl">
            ...
            <button onClick={() => onNavigate('report-incident')} className="w-full py-2 bg-amber-600 hover:bg-amber-500 text-white font-bold rounded-lg shadow-lg shadow-amber-200 transition-all text-xs uppercase tracking-wider">Сообщить об аварии</button>
          </div>
        )}
      </div>
    </aside>
