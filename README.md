...
- ✅ **Управление персоналом**: создание профилей, распределение по подразделениям, назначение ролей
...
Фронтенд будет доступен по адресу `http://localhost:3000`, а API - через проксирование с фронта.
...
### Создание начальника цеха (администратора)

Для быстрого создания профиля "Начальник цеха" с ролью `ADMIN`, выполните в директории `backend/`:
